...
class COND_NET(nn.Module): #not chnaged yet
    ...
    def __init__(self):
        ...
        self.t_dim = int(2*4*cfg.RAY_CASTING_IMAGE_RESOLUTION/8*cfg.RAY_CASTING_IMAGE_RESOLUTION/8)+3+3+3  ## 3 is source_location, 3 is microphone_location, 3 is room_dims
