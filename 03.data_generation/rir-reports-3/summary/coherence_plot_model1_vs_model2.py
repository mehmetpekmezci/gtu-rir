...
def saveRealAndGeneratedPlots(real_data,generated_data,MSE,SSIM,glitch_points,MFCC_MSE,MFCC_SSIM,MFCC_CROSS_ENTROPY,saveToPath,REAL_ON_TOP,MODEL1NAME,MODEL2NAME):
     #plt.clf()
...
MODEL1NAME=sys.argv[3]
MODEL2NAME=sys.argv[4]
...
REAL_ON_TOP=0
saveRealAndGeneratedPlots(real_data,generated_data,MSE,SSIM,glitch_points,MFCC_MSE,MFCC_SSIM,MFCC_CROSS_ENTROPY,second_sound_file+'.'+MODEL1NAME+'.'+MODEL2NAME+'.model_comparison.png',REAL_ON_TOP,MODEL1NAME,MODEL2NAME)

REAL_ON_TOP=1
#Real signal is plot in front of generated one.
saveRealAndGeneratedPlots(real_data,generated_data,MSE,SSIM,glitch_points,MFCC_MSE,MFCC_SSIM,MFCC_CROSS_ENTROPY,second_sound_file+'.'+MODEL1NAME+'.'+MODEL2NAME+'.model_comparison_real_front.png',REAL_ON_TOP,MODEL1NAME,MODEL2NAME)
