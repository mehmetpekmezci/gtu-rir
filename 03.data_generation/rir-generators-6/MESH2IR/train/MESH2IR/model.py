...
class MESH_NET(nn.Module):
    ...
    def forward(self, data):
        ...
        print("x shape2.1 ", x.shape)
        x1 = torch.cat([gmp(x, batch), gap(x, batch)], dim=1)
        print("x shape2.2 ", x.shape)
        print("x1 shape2.2 ", x1.shape)

        x = F.relu(self.conv2(x, edge_index))
        print("x shape2.3 ", x.shape)
     
        x, edge_index, _, batch, _,_ = self.pool2(x, edge_index, None, batch)
        print("x shape2.4 ", x.shape)
        x2 = torch.cat([gmp(x, batch), gap(x, batch)], dim=1)
        print("x shape3 ", x.shape)
        print("x2 shape3 ", x2.shape)

        x = F.relu(self.conv3(x, edge_index))
        print("x shape3.1 ", x.shape)

        x, edge_index, _, batch, _,_ = self.pool3(x, edge_index, None, batch)
        print("x shape3.2 ", x.shape)
        x3 = torch.cat([gmp(x, batch), gap(x, batch)], dim=1)
        print("x shape3.3 ", x.shape)
        print("x3 shape3.3 ", x3.shape)
        ...
        x = self.lin1(x)
        print("x shape4.1 ", x.shape)
        x = self.act1(x)
        print("x shape5 ", x.shape)
        # x = self.lin2(x)
        # x = self.act2(x)      
        x = F.dropout(x, p=0.5, training=self.training)
        print("x shape5.1 ", x.shape)
        # print("x shape2 ", x.shape)
...
'''
x shape1  torch.Size([4936, 3])
x shape2  torch.Size([4936, 32])
x shape2.1  torch.Size([2962, 32])
x shape2.2  torch.Size([2962, 32])
x1 shape2.2  torch.Size([2, 64])
x shape2.3  torch.Size([2962, 32])
x shape2.4  torch.Size([1778, 32])
x shape3  torch.Size([1778, 32])
x2 shape3  torch.Size([2, 64])
x shape3.1  torch.Size([1778, 32])
x shape3.2  torch.Size([1068, 32])
x shape3.3  torch.Size([1068, 32])
x3 shape3.3  torch.Size([2, 64])
x shape4  torch.Size([2, 64])
x shape4.1  torch.Size([2, 16])
x shape5  torch.Size([2, 16])
x shape5.1  torch.Size([2, 16])
x shape6  torch.Size([2, 8])
'''
