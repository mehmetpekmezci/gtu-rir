...
#        print(netD)
        ...
        RANDOM_VECTOR_SIZE=10
        summary(netG,[(self.batch_size,SOURCE_RECEIVER_XYZ_DIM),(self.batch_size,RANDOM_VECTOR_SIZE)] )
              ...
              try: 
                ...
                with torch.no_grad():
                    ...
                    # mesh_embed=torch.concatenate((mesh_embedding_source_image_latents,mesh_embedding_receiver_image_latents),axis=1)
                     RANDOM_VECTOR_SIZE=10 # model.py icinde de bu degisken var.
                     mesh_embed=torch.rand(self.batch_size,RANDOM_VECTOR_SIZE).cuda()
                ...
                if generator_lr > 0.000000005 and i>0 and i%100==0:
                    rate=0.5
