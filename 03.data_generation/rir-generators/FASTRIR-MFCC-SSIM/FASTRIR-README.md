...
This readme file and all of the code in this ditectory is from https://github.com/anton-jeran/FAST-RIR
We just modified some parts, you can also download the codes and tkae diff with this directory.
