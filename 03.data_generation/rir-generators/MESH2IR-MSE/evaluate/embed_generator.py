...
def permuteGANInput(x,y,z,roomDepth,roomWidth,roomHeight):
     ...
     #print(f"x={x}, roomDepth={roomDepth} , x-roomDepth/2={x-roomDepth/2}, y={y}, roomWidth={roomWidth}, y-roomWidth/2={y-roomWidth/2}")     
     return  x-roomDepth/2,z,y-roomWidth/2
...
for dataline in rir_data:
              ...
              mesh2irInputDataLine=[roomId+"-freecad-mesh-Body.pickle",configId,"SPEAKER_ITERATION-"+speakerMotorIterationNo+"-MICROPHONE_ITERATION-"+microphoneMotorIterationNo+"-PHYSICAL_SPEAKER_NO-"+physicalSpeakerNo+"-MICROPHONE_NO-"+micNo+".wav",[speakerCoordinatesX,speakerCoordinatesY,speakerCoordinatesZ],[microphoneCoordinatesX,microphoneCoordinatesY,microphoneCoordinatesZ]]
