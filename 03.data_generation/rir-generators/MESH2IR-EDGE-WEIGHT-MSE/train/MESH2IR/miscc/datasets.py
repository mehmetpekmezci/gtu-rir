...
class TextDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # MP : -1,1 interval wont be mapped to 0,1 because in fact direction is not important , important thing is just the positive value of the cosine theta.  Either in front of the , or behind the spekaer, the angle between the spekaer and wall behaves the same.
