...
transmit_data=transmit_data* 1/np.max(transmit_data)
...
saveRealAndGeneratedPlots(transmit_data,reverbed_data,rir_fname+'.reverbed_song_cherence_plot.png')
saveRealAndGeneratedPlots(transmit_data,reverbed_data,rir_fname+'.reverbed_song_cherence_plot.real_front.png',real_front=True)
