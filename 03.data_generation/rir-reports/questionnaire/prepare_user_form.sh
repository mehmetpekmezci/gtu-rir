...
function print_room {
   ...
   RIR_PLOT_FASTRIR_MSE=$(echo $RIR_PLOT_LIST| cut -d, -f1)
   RIR_PLOT_FASTRIR_SSIM=$(echo $RIR_PLOT_LIST| cut -d, -f2)
   RIR_PLOT_FASTRIR_SSIM_PLUS_MSE=$(echo $RIR_PLOT_LIST| cut -d, -f3)
   RIR_PLOT_MESH2IR_MSE=$(echo $RIR_PLOT_LIST| cut -d, -f4)
   RIR_PLOT_MESH2IR_SSIM=$(echo $RIR_PLOT_LIST| cut -d, -f5)
   RIR_PLOT_MESH2IR_SSIM_PLUS_MSE=$(echo $RIR_PLOT_LIST| cut -d, -f6)
   RIR_PLOT_MESHTAE=$(echo $RIR_PLOT_LIST| cut -d, -f7)
...
echo "
  ...
  <tr>   
    ...
    <td> - </td>
    <td> - </td>
    <td> <audio controls style='width: 250px;'><source src='$SONG_REAL' type='audio/wav'></audio></td>
    <td>10</td>
  </tr>   
  <tr>   
