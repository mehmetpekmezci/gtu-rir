...
echo "
  ...
  <tr> 
   <td style='width: 250px;' ><h2>TYPE</h2></td><td><h2>RIR COHERENCE PLOT</h2></td><td><h2>SONG COHERENCE PLOT</h2></td><td><h2>AUDIO</h2></td><td style='width: 50px;'><h2>RATING</h2></td>
  </tr>
  <tr>   
  ...
  <tr> 
   <td colspan='5' bgcolor='#adb9c8' width='100%' height='40px'> </td>
  </tr>
" >> user_form.html
}
